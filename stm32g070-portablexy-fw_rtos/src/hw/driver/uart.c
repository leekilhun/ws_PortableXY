...
bool uartOpen(uint8_t ch, uint32_t baud)
{
  ...
  switch(ch)
  {
    ...
    case _DEF_UART3:
    {
      ...
      HAL_NVIC_SetPriority(DMA1_Ch4_7_DMAMUX1_OVR_IRQn, PRIORITY_ORDER, 0);
  ...
  ret = length;
    ...
    case _DEF_UART2:
    {
      ...
      if (huart2.gState == HAL_UART_STATE_READY)
      {
        ...
        status = HAL_UART_Transmit_DMA(&huart2, &uart2_tx_data[0], length);
      }
#else
...
#if defined(_USE_HW_UART_1_DMA) ||  defined(_USE_HW_UART_2_DMA)
...
#if defined(_USE_HW_UART_3_DMA) ||  defined(_USE_HW_UART_2_DMA)
...
/* USART1 interrupt Init */
  ...
  else if(uartHandle->Instance==USART2)
  {
    ...
    HAL_NVIC_SetPriority(USART2_IRQn, PRIORITY_ORDER, 0);
